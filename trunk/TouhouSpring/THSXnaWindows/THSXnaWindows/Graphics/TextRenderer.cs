...
namespace TouhouSpring.Graphics
{
    ...
    partial class TextRenderer : Services.GameService
    {
        ...
        private SystemGraphics m_drawContext;
        ...
        private GlyphData Load(char glyph, SystemFont font)
        {
            ...
            var size = m_drawContext.MeasureString(str, font);
            ...
            using (var memStream = new MemoryStream())
            {
                ...
                using (var tmpTexture = Texture2D.FromStream(GameApp.Instance.GraphicsDevice, memStream))
                {
                    ...
                    foreach (var batch in pages.GroupBy(page => page.m_pageIndex / PagesInOneCacheTexture))
                    {
                        ...
                        var vertices = new BlitVertex[pagesInBatch.Length * 6];
                        ...
                        {
                            pass.Apply();
                            device.DrawUserPrimitives(PrimitiveType.TriangleList, vertices, 0, pagesInBatch.Length * 2, m_vertexDeclaration);
                        }
                    }
        ...
        public override void Startup()
        {
            ...
            {
                m_drawContext = SystemGraphics.FromImage(empty);
                m_drawContext.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAliasGridFit;
            }
            m_whiteBrush = new SystemSolidBrush(System.Drawing.Color.White);
