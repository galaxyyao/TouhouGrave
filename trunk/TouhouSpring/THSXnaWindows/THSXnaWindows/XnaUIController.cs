...
namespace TouhouSpring
{
    class XnaUIController : BaseController
    {
        ...
        public override void OnRespondBack(Interactions.BaseInteraction io, object result)
        {
            ...
            {
                m_agents[(io as Interactions.MessageBox).Player.Index].OnRespondBack(io, result);
            }
            ...
            {
                m_agents[(io as Interactions.SelectCardModel).Player.Index].OnRespondBack(io, result);
            }
